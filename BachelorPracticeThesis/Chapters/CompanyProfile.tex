...
\begin{itemize}
    ...
    \item \textbf{Vývoj backendu (BE):} Implementace doplňku (Add-in) v jazyce \textbf{C\#} \cite{csharp_docs}, který zajišťuje logiku zpracování dat a komunikaci s databází.
